 ...
 * @class Node2d
 *
 * @brief Implements a class of 2-dimensional node.
 */
class Node2d {
public:
 ...
 * @class GridSearch
 *
 * @brief Implements a class of GridSearch using astar algorithm.
 */
class GridSearch {
public:
  explicit GridSearch(const HybridAstarConfig &open_space_conf);
...
private:
  ...
  std::vector<ObstacleInfo> obstacles_vec_;
...
private:
  double DistanceTo(Point2D p, ObstacleInfo obstacle) const;
};